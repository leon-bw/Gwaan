      ...
      <div className="container max-w-screen-2xl mx-auto pt-12 pb-20 px-4 lg:px-14 md:pt-5 md:pb-10">
        <div className="md:flex items-center gap-2">
          <div className="md:w-[478px]">
            ...
            <div className="flex gap-4 items-center mt-8 flex-wrap">
              <Button
                size="lg"
                variant="secondary"
                className="font-semibold bg-white text-black hover:bg-white/30 hover:border-seaGreen hover:text-white transition ease-in-out"
              >
                Get Early Access
              </Button>
              <Button
          ...
          <div className="mt-20 md:mt-0 md:h-[648px] md:flex-1 relative">
            <Image src={RobotImage} alt="AI Robot image" className="md:absolute md:h-full md:w-auto md:max-w-none md:-left-6 lg:left-0"/>
          </div>
        </div>
      </div>
    </section>
